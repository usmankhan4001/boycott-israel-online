  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-zinc-50 dark:bg-zinc-950 p-4 font-sans" dir="ltr" lang="en">
      <div className="max-w-md w-full p-8 rounded-3xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 shadow-2xl space-y-6 text-center">
        ...
        {error && (
          <div className="p-3 rounded-xl bg-rose-50 dark:bg-rose-950/50 border border-rose-200 dark:border-rose-900 text-rose-700 dark:text-rose-300 text-sm font-bold flex items-center gap-2">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 text-left">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-2xl bg-zinc-50 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 text-zinc-900 dark:text-zinc-100 text-sm focus:outline-none focus:border-red-500"
            />
          </div>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full py-3 rounded-2xl bg-red-600 hover:bg-red-500 disabled:opacity-50 text-white font-black shadow-lg shadow-red-600/20 transition-all"
          >
